...
const submitBooking = () => {
    ...
    let response = fetch('/api/bookings/submit', {
        ...
        if (data.status === "200") {
            ...
            continueBtn.classList.add('bg-green-500', 'shadow-md', 'scale-105', 'border-green-500','hover:bg-green-300','hover:text-green-300','hover:border-green-300', 'outline-none', 'text-green-800');
